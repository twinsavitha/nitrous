class PublishesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @publish.save
         format.html { redirect_to :controller=>"authors",:action=>"new",:publish_id=>@publish.id, notice: 'User was successfully created.' }
  ...
  def destroy
    @publish.destroy(publish_params)
    respond_to do |format|
  ...
  private
    ...
    def publish_params
      params.require(:publish).permit(:topic, :text)
    end
end
